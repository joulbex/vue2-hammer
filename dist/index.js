(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue2-hammer"] = factory();
	else
		root["vue2-hammer"] = factory();
    ...
    Vue.directive('hammer', {
      bind: function bind(el, binding) {
        ...
        if ((0, _keys2.default)(direction).length) {
          (0, _keys2.default)(direction).map(function (keyName) {
            that.config[event].direction = String(keyName);
          });
        }

        var recognizerType = void 0,
            recognizer = void 0;

        if (that.customEvents[event]) {
          // custom event
          var custom = that.customEvents[event];
          recognizerType = custom.type;
          recognizer = new _hammerjs2.default[that.capitalize(recognizerType)](custom);
          ...
          if (!recognizer) {
            // add recognizer
            recognizer = new _hammerjs2.default[that.capitalize(recognizerType)]();
